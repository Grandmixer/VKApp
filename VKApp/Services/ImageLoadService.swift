...
//  VKApp
//
//  Created by Желанов Александр Валентинович on 27.02.2021.
...
class ImageLoadService {
    ...
    private func getFilePath(url: String) -> String? {
        ...
        return cachesDirectory.appendingPathComponent(ImageLoadService.pathName + "/" + hashName).path
    }
